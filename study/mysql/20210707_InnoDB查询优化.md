...
![4.05_explain_table](D:\study_note\maningning1.github.io\images\mysql\4.05_explain_table.png)
...
+ 对于包含子查询的语句来说，就涉及多个select关键字，如下所示：
  ...
  ![4.06_explain_id_子查询](D:\study_note\maningning1.github.io\images\mysql\4.06_explain_id_子查询.png)
...
+ 对于包含union子句的查询语句，它会把多个子查询的结果集并起来并去重，所以就会在内部创建一张临时表，如下所示：
  ...
  ![4.07_explain_union](D:\study_note\maningning1.github.io\images\mysql\4.07_explain_union.png)
  ...
  ![4.08_explain_union_all](D:\study_note\maningning1.github.io\images\mysql\4.08_explain_union_all.png)
...
+ **DERIVED**：在包含派生表的查询中，如果是以物化派生表的方式执行查询，则派生表对应的子查询的select_type就是DERIVED，如下所示：
  ...
  ![4.09_explain_derived](D:\study_note\maningning1.github.io\images\mysql\4.09_explain_derived.png)
...
+ **eq_ref**：连接查询时，被驱动表通过主键或者不允许为null的唯一二级索引进行等值匹配方式进行访问，如下所示：
  ...
  ![4.10_explain_type_eq_ref](D:\study_note\maningning1.github.io\images\mysql\4.10_explain_type_eq_ref.png)
...
![4.11_explain_keys](D:\study_note\maningning1.github.io\images\mysql\4.11_explain_keys.png)
...
![4.12_explain_key_len_int](D:\study_note\maningning1.github.io\images\mysql\4.12_explain_key_len_int.png)
...
![4.13_explain_key_len_varchar](D:\study_note\maningning1.github.io\images\mysql\4.13_explain_key_len_varchar.png)
...
![4.14_explain_filtered](D:\study_note\maningning1.github.io\images\mysql\4.14_explain_filtered.png)
...
+ **No tables used**：查询语句中没有from子句；
  ...
  ![4.15_explain_extra_no_tables_used](D:\study_note\maningning1.github.io\images\mysql\4.15_explain_extra_no_tables_used.png)
...
+ **Using index**：使用覆盖索引；
  ...
  ![4.16_explain_extra_using_index](D:\study_note\maningning1.github.io\images\mysql\4.16_explain_extra_using_index.png)
...
+ **Using index condition**：使用到了索引条件下推，如下所示例子中`supplier_order_id like '20%'`可以生成扫描区间，但是`supplier_order_id like '%1'`不能生成扫描区间，但是因为搜索条件列是一个，可以根据第二个搜索先做匹配，减少回表次数；
  ...
  ![4.17_explain_extra_using_index_condition](D:\study_note\maningning1.github.io\images\mysql\4.17_explain_extra_using_index_condition.png)
